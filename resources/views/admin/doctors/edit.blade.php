            ...
            <form class="forms-sample" action="{{ route('doctors.update', $doctor->id) }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="color: #fff;" id="phone" name="phone"
                        value="{{ $doctor->phone }}" placeholder="Phone">
                    @error('phone')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select name="speciality" id="speciality" class="form-control" style="color: #fff;">
                        ...
                        <option value="heart" @if ($doctor->speciality === 'heart') selected @endif>Heart</option>
                        <option value="eye" @if ($doctor->speciality === 'eye') selected @endif>Eye</option>
                        <option value="nose" @if ($doctor->speciality === 'nose') selected @endif>Nose</option>
                    </select>
                    @error('speciality')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="color: #fff;" id="room_no" name="room_no"
                        value="{{ $doctor->room_no }}" placeholder="Phone">
                    @error('room_no')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
